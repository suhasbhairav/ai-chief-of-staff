...
const initialMessages = [
  {
    role: "assistant",
    content:
      "Ask me about any department, company risk, board narrative, operating priority, or metric tradeoff. I will retrieve the relevant Supabase vector context first, then use OpenAI only when you send a question.",
    sources: [],
  },
];
        ...
        <div className="grid gap-4 p-4 sm:p-5 lg:grid-cols-[minmax(0,1fr)_18rem] lg:p-6">
          <div>
            <div className="mb-3 inline-flex rounded-full border border-white/10 bg-white/5 px-3 py-1 text-xs font-semibold text-zinc-300">
              Supabase vector memory + guarded OpenAI reasoning
            </div>
        ...
        <div className="flex min-h-[36rem] flex-col overflow-hidden rounded-lg border border-zinc-800 bg-[#101013]">
          ...
          >
            ...
            <p className="mt-2 text-xs text-zinc-500">
              No analysis runs on page load. OpenAI is called only when you ask or rebuild embeddings.
            </p>
          </form>
        </div>
