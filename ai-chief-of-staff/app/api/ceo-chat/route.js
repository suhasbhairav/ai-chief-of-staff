...
import { searchDepartmentEmbeddings } from "@/lib/llm/department-embeddings";
...
export async function POST(request) {
  try {
    ...
    const plannerResponse = await guardedResponsesCreate(null, {
...
${message}`,
    ...
    const answerResponse = await guardedResponsesCreate(null, {
