...
const drawInsightPage = (doc, report) => {
  ...
  let y = addSectionTitle(
    ...
    "Latest LLM-generated recommendation text included from the dashboard state.",
    54
  );
  ...
  doc.text(report.insights || "No LLM synthesis has been generated yet.", 58, y + 26, {
    maxWidth: 480,
...
const drawMethodology = (doc, report) => {
  ...
  autoTable(doc, {
    ...
    body: [
      ...
      ["AI Synthesis", "LLM recommendations are included only after the user explicitly fetches suggestions."],
